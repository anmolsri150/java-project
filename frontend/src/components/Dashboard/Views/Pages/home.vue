...
<!--      <p class="lead" style="left:20%;position:relative;">-->
<!--        <form class="navbar-form navbar-left navbar-search-form" role="search" style="left:38%;position:relative;padding-right:30px;">-->
...
<!--    </carousel>-->
    ...
    <v-container>
      <v-row>
        <template v-for="(item, x) in this.menu">
          <v-col sm="3">
            <Hospitalcard :title="item.name" :desc="item.desc" :price="item.price" :type="item.category" :index="x" :img="imgg"></Hospitalcard>
          </v-col>
        </template>
<!--        <v-col sm="3">-->
