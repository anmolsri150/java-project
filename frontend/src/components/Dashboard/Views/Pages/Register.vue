            ...
            <div class="row">
              <div class="col-md-8 col-md-offset-2">
                <div class="header-text">
                  <h2>Medika - Profile</h2>
                  <h4>Register to get a whole new medical experience</h4>
                  <hr>
                </div>
              </div>
              <div class="col-md-4 col-md-offset-2">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    <h5>Avoid Queues</h5>
                    Book appointments online, get an amazing hassle free medical experience.
                  </div>
                </div>
                <div class="media">
                  <div class="media-left">
        ...
        <footer class="footer footer-transparent">
          <div class="container">
            <div class="copyright text-center">
              &copy;
              <a href="https://www.medika.ml" target="_blank">Medika</a>.
            </div>
          </div>
        </footer>
      </div>
